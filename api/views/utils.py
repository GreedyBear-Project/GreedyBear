...
def stream_ioc_objects(iocs, verbose=False, include_sensors=False):
    ...
    # `payload_hashes` follows it too and is only annotated on the advanced feed.
    if isinstance(iocs, list):
        ...
        has_payload_hashes = bool(iocs) and hasattr(iocs[0], "payload_hashes")
    else:
        ...
        has_payload_hashes = "payload_hashes" in annotations
