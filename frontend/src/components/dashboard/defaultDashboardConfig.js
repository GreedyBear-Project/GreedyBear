...
export const DASHBOARD_LAYOUTS = {
  lg: [
    ...
    { i: "AttackOriginMap", x: 0, y: 27, w: 8, h: 10, static: true },
    { i: "AttackOriginCountriesChart", x: 8, y: 27, w: 4, h: 10, static: true },
  ],
  ...
  md: [
    ...
    { i: "AttackOriginMap", x: 0, y: 45, w: 12, h: 10, static: true },
    {
